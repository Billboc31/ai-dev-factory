...
from .routes import approvals, auto_fix, batches, daemon, deployer, diagnostics, dispatcher, eligibility, environments, health, intelligence, issues, operations, project_map, projects, providers, readiness, rules, runtime_dashboard, sandbox, settings, tickets, workspace
...
def create_app(
    ...
    # T201: /projects/{id}/rules + /tickets/{id}/rule-evaluation — advisory rules engine.
    ...
    # T204: /tickets/{id}/operations — guarded manual recovery actions.
    app.include_router(operations.router)
    app.include_router(operations.project_router)
    # T211: /tickets/{id}/eligibility — unified READY_TO_TAKE decision aggregator.
    app.include_router(eligibility.router)
    app.include_router(eligibility.project_router)
    ...
    # T225: /projects/{id}/workspace/* — persistent AI workspace (Supervisor proxy).
